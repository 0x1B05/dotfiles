...
return {
	...
	s(
		...
		fmta([[fig, ax = plt.subplots(<>)]], { d(1, get_visual) }),
	...
	s(
		...
		fmta([[ax.plot(<>)]], { d(1, get_visual) }),
		{ condition = line_begin }
	),
	-- AXIS SET_XLABEL
	s(
		{ trig = "xxl", snippetType = "autosnippet" },
		fmta([[ax.set_xlabel(<>)]], { d(1, get_visual) }),
		{ condition = line_begin }
	),
	-- AXIS SET_YLABEL
	s(
		{ trig = "xyl", snippetType = "autosnippet" },
		fmta([[ax.set_ylabel(<>)]], { d(1, get_visual) }),
		{ condition = line_begin }
	),
	-- AXIS SET_TITLE
	s(
		{ trig = "xt", snippetType = "autosnippet" },
		fmta([[ax.set_title(<>)]], { d(1, get_visual) }),
		{ condition = line_begin }
	),
	-- TIGHT LAYOUT
