...
return {
	...
	s({ trig = "LL", snippetType = "autosnippet" }, fmt([[`{} <{}>`_]], { d(1, get_visual), i(2) })),
	-- Inline hyperlink capturing URL
	s({ trig = "LU", snippetType = "autosnippet" }, fmt([[`{} <{}>`_]], { i(1), d(2, get_visual) })),
	-- Hack to remove indentation in bulleted lists
	s({ trig = "  --", snippetType = "autosnippet" }, { t("- ") }, { condition = line_begin }),
	s({ trig = "   ##", snippetType = "autosnippet" }, { t("#. ") }, { condition = line_begin }),
	-- Heading
	s({ trig = "h1", snippetType = "autosnippet" }, { i(1) }, {
	...
	-- Heading
	s({ trig = "h2", snippetType = "autosnippet" }, { i(1) }, {
		condition = line_begin,
		callbacks = {
			[1] = {
				[events.leave] = function(node, _event_args)
	...
	-- Heading
	s({ trig = "h3", snippetType = "autosnippet" }, { i(1) }, {
		condition = line_begin,
		callbacks = {
			[1] = {
				[events.leave] = function(node, _event_args)
