...
█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█▄▄▄▄▄▄▄█   ⡟⠄⠄⠄⠄⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⢿⣟⣻⣩⣾⣃⣴⣿⣿⡇⠸⢾     █▄▄▄█ █▄▄▄█▄█   █▄█]],
                keys = {
                    ...
                    { icon = " ", key = "c", desc = "Configuration", action = ":lua Snacks.picker.files({cwd = vim.fn.stdpath('config')})" },
        ...
        explorer = { enabled = true }, -- 侧边栏文件树，替代 neo-tree/nvim-tree
        indent = { enabled = true },   -- 缩进线，替代 indent-blankline
        input = { enabled = true },    -- 更好的 vim.ui.input
        picker = { enabled = true },   -- 替代 Telescope
        notifier = { enabled = true }, -- 替代 nvim-notify
    ...
    keys = {
        ...
        { "<leader>tn", function() Snacks.terminal("ncdu") end, desc = "Ncdu" },
        ...
        { "<c-h>", function() require("tmux").move_left() end, mode = "t", desc = "Go to Left Window" },
        { "<c-j>", function() require("tmux").move_bottom() end, mode = "t", desc = "Go to Lower Window" },
        { "<c-k>", function() require("tmux").move_top() end, mode = "t", desc = "Go to Upper Window" },
        { "<c-l>", function() require("tmux").move_right() end, mode = "t", desc = "Go to Right Window" },
